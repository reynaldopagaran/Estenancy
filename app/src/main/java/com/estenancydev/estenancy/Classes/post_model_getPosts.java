...
public class post_model_getPosts {
    ...
    public post_model_getPosts(String distace, String address, String title, String name, Bitmap profilePic, Bitmap thumbnail, String timeStampx, String id, String email, String stat, String desc) {
        this.setTitle(title);
        this.setName(name);
